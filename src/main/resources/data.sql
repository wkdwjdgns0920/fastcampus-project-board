...
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at, modified_by) values
    ('jhjang', 'asdf1234', 'Jhjang', 'jhjang@mail.com', 'I am Jhjang.', now(), 'jhjang', now(), 'jhjang')
;
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at, modified_by) values
    ('jhjang2', 'asdf1234', 'Jhjang2', 'jhjang2@mail.com', 'I am Jhjang2.', now(), 'jhjang2', now(), 'jhjang2')
;
